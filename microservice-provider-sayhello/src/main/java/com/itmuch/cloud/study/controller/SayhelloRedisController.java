...
import com.itmuch.cloud.study.entity.SayHelloRedis;
import com.itmuch.cloud.study.service.impl.SayHelloRedisService;
...
public class SayhelloRedisController {

    @Autowired
    SayHelloRedisService redisService;
    ...
    public String setObj(String key, SayHelloRedis user){
        try {
